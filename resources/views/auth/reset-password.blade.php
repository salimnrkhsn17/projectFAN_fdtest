...
<head>
    ...
    <title>Reset Password | FANBook</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="reset-bg-blur"></div>
    <div class="reset-container">
        <div class="reset-title">Ubah Password</div>
        <div class="reset-subtitle">Masukkan email dan password baru Anda.</div>
